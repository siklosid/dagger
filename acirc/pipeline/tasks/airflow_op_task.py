...
class AirflowOpTask(Task):
    ...
    def init_attributes(cls, orig_cls):
        cls.add_config_attributes([
            Attribute(attribute_name='module', parent_fields=['task_parameters'],
                      comment='Name of the module to import from. E.g.: airflow.opeartors.python_operator'),
            Attribute(attribute_name='class_name', parent_fields=['task_parameters'],
                      comment="Name of the operator class. E.g.: PythonBranchOperator"),
            Attribute(attribute_name='python', parent_fields=['task_parameters'], required=False,
                      comment="Relative path to python file that implements the function"),
            Attribute(attribute_name='function', parent_fields=['task_parameters'], required=False,
